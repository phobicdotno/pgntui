...
| `batteries`           | 127508                        | voltage/current/temp for instances 0–3 |
| `engine-main`         | 127488, 127489                | rpm, boost, tilt/trim, oil, temps, alternator, fuel, hours, load, torque |
| `engine-status`       | 127489 Discrete Status 1/2    | 24 status lamps (canboat ENGINE_STATUS_1/2 bit order) |
| `engine-transmission` | 127493                        | gear oil temp/pressure + 5 status lamps |
